...
def nyt_mostviewed(section='national', time_period=1, offet=0, n=5, results=None, api_key=''):
    ...
    https://api.nytimes.com/svc/mostpopular/v2/mostviewed/all-sections/1.json?api_key=REDACTED
    https://api.nytimes.com/svc/mostpopular/v2/mostviewed/national/1.json?api_key=REDACTED
    Example :-
        {
          "status": "string",
          "copyright": "string",
